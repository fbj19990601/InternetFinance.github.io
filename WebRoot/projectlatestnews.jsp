...
<%@ page
	...
	com.lechou.project.catagory.*,com.lechou.project.latestnews.*,com.lechou.order.*,
	com.lechou.project.comment.*,com.lechou.project.latestnews.*,java.util.*,java.text.*'%>
...
<%
	...
	String requesturl = "projectlatestnews.jsp";
	...
	ProjectVO projectvo = ProjectMgr.getInstance().getProjectVOById(
	 ...
	 List <ProjectLatestnewsVO> latestnewsvos = new ArrayList<ProjectLatestnewsVO>();
	 ProjectLatestnewsMgr.getInstance().getLatestnewsByProjectId(latestnewsvos, pk_project);
	...
	<div class="header">
		<div class="wrap clearfix">
			...
			<div class="m-right clearfix">
				<!--not login 
        	<span class="z-Login">
			<a id="user_register" class="z-register Js-showRegister" href="javascript:;">注册</a>
			...
			<div id="Js-detail" class="m-matter white">
				<ul class="particulars-list-nav clearfix Js-topbill">
					...
					<li class="selected">
						...
						%><a
						id="deal_detail_home"
						href="projectlatestnews.jsp?pk_project=<%=projectvo.getPk_project()%>">项目进展(<%=ProjectLatestnewsMgr.getInstance()
						.getLatestnewSCountByProjectId(pk_project)%>)</a>
					</li>
					<li><a id="deal_detail_home"
						href="projectinvestor.jsp?pk_project=<%=projectvo.getPk_project()%>">投资人(<%=OrderMgr.getInstance().getOrderCountByProjectId(
						pk_project)%>)</a>
					</li>
					<%
						}
				...
				<div class="m-topics m-topics2">
					
					<ul class="time-list">
<%
                        for(Iterator<ProjectLatestnewsVO>it=latestnewsvos.iterator();it.hasNext();){
                        ProjectLatestnewsVO latestnewsvo = it.next();
     %>
						<li><i class="circlek"></i> <span class="time-zhou"><%=new SimpleDateFormat("MM-dd").format(latestnewsvo
						.getPublishtime()) %></span>
						
							<p class="p-content"><%=latestnewsvo.getContent() %></p>
							<p class="line"></p></li>
<%} %>
