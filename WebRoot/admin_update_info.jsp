...
<body>
	...
	<div class="wrap pb116 clearfix">
		...
		<div class="personal-set-left">
			<ul>
				<li class="selected"><a href="admin_update_info.jsp">资料修改</a>
				</li>
				<li><a href="admin_update_password1.jsp">密码修改</a>
				</li>
				</ul>
		</div>
		<!--left side end-->
		...
		<div class="personal-set-right">
			<form class="setting-form" name="modify"
				...
				<div class="form-item clearfix">
					...
					<div class="row clearfix">
						<label>个人说明：</label>
						<textarea name="resume" placeholder="您的介绍可更有效的帮助支持者了解您和了解项目的背景"><%=currentUserVO.getResume()==null?"":currentUserVO.getResume()%></textarea>
					</div>
					<p class="p-btn">
